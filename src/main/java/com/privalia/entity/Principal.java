...
public class Principal {
	...
	public static void main(String[] args) {
		...
		StringBuilder stringBuilderConstructor = new StringBuilder();
		stringBuilderConstructor.append(studentConstructor.getIdStudent());
		...
		stringBuilderConstructor.append(" ");
		stringBuilderConstructor.append(studentConstructor.getAddress().getIdAddress());
		stringBuilderConstructor.append(" ");
